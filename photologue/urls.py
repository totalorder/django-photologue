...
urlpatterns = patterns('',
                       ...
                       url(r'^album/(?P<year>\d{4})/(?P<month>[a-z]+)/(?P<day>\w{1,2})/$',
                           GalleryDayArchiveView.as_view(),
                           name='pl-gallery-archive-day'),
                       url(r'^album/(?P<year>\d{4})/(?P<month>[a-z]+)/$',
                       ...
                       url(r'^bilder/(?P<year>\d{4})/(?P<month>[a-z]+)/(?P<day>\w{1,2})/(?P<slug>[\-\d\w]+)/$',
                           PhotoDateDetailView.as_view(),
                           name='pl-photo-detail'),
                       url(r'^bilder/(?P<year>\d{4})/(?P<month>[a-z]+)/(?P<day>\w{1,2})/$',
                           PhotoDayArchiveView.as_view(),
                           name='pl-photo-archive-day'),
                       url(r'^bilder/(?P<year>\d{4})/(?P<month>[a-z]+)/$',
                           PhotoMonthArchiveView.as_view(),
                           name='pl-photo-archive-month'),
                       url(r'^bilder/(?P<year>\d{4})/$',
